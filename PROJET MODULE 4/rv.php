...
<button  class="w3-button w3-black w3-round-large w3-hover-orange" onclick="document.getElementById('ticketModal7').style.display='block'">Prendre un rendez-vous</button>

<div class="w3-center">
    <img src="images/logo.png" style="width:15%">
    <h3 class="w3-text-" style="color:white">E-Building</h3>
    <div class="w3-text-grey ">
      
      <p class="w3-center " style="color:black"><b>Le choix du E-Building</b></p>    
    </div>
  </div>
...
<form action="traitement_rv.php" method="post">
                    <div id="ticketModal7" class="w3-modal">
                        ...
                        class="w3-button w3-red w3-xlarge w3-display-topright">×</span>
                            <h4 class="w3-wide"><i class="fa fa-user w3-margin-right"></i>Ce formulaire est adressé aux agents immobiliers qui voudraient publier leurs locaux sur E-Building</h4>
                        </header>
                        <div class="w3-container">
                            ...
                            <input type="submit" value="Envoyer" class="w3-button w3-block w3-blue w3-padding-16 w3-section w3-right">
                            <button class="w3-button w3-black w3-section" onclick="document.getElementById('ticketModal7').style.display='none'">Fermer<i class="fa fa-remove"></i></button>
